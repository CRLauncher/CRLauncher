...
public class PageButton extends JToggleButton {
    ...
    public PageButton(String text, int page) {
        super(text);
    ...
    private void paintBackground(Graphics2D g2d) {
        ...
        g2d.setColor(color);
        g2d.fillRoundRect(0, 0, this.getWidth(), this.getHeight(), PageButton.SIZE.width, PageButton.SIZE.height);
    }
