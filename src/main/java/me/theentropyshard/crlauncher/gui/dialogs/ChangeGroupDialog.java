...
public class ChangeGroupDialog extends AppDialog {
    ...
    public ChangeGroupDialog(CosmicInstance instance, Set<String> groups) {
        super(CRLauncher.frame, CRLauncher.getInstance().getLanguage().getString("gui.changeGroupDialog.title")
        ...
        comboBox.setSelectedItem(instance.getGroupName());
