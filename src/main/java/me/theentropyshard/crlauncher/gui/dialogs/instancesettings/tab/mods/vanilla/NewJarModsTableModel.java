...
public class NewJarModsTableModel extends AbstractTableModel {
    ...
    public NewJarModsTableModel(Instance instance) {
    ...
    public Class<?> getColumnClass(int columnIndex) {
        return NewJarModsTableModel.COLUMN_CLASSES[columnIndex];
    }
