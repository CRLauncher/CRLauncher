...
```shell
$ java -jar dist/CRLauncher-0.2.4.jar
```

If you want to change the location of launcher's files, add `--workDir` argument:
```shell
$ java -jar dist/CRLauncher-0.2.4.jar --workDir C:\Users\User\Documents\CRLauncher
```
...
```shell
$ java -jar dist/CRLauncher-0.2.4.jar --useJarLocation
```
